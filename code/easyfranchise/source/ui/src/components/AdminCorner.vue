    ...
    <div class="container">
        <div class="row">
          <div class="col">
            ...
            <p>Update the following details needed to customize the application for your company.</p>
          </div>
        ...
        <div class="row">  
          ...
          <fd-field-set>
            ...
            <fd-form-item>
              <fd-form-label>Technical email used to send notifications</fd-form-label>
              <fd-input v-model="technicalEmail" />
            </fd-form-item>
            <fd-form-item>
              <fd-form-label>Password for technical email</fd-form-label>
              <fd-input v-model="technicalEmailPassword" type="password"/>
            </fd-form-item>
          </fd-field-set>
        </div>
    </div>
...
export default {
  ...
  props: ["allMentors", "allCoordinators", "allFranchises", "companyName", "logoUrl", "technicalEmail", "technicalEmailPassword"],
  data: function() {
    return {
      alertStatus: false,
      selectedIds: [],
  ...
  methods: {
    ...
    saveCompanyDetails(){
      ...
      } else if (this.technicalEmail && !this.technicalEmailPassword || !this.technicalEmail && this.technicalEmailPassword ) {
        this.alertStatus = true;
        console.log("[DEBUG] Email address or password not available:", this.technicalEmail +  + " - " + this.technicalEmailPassword)
      } else {
        this.alertStatus = false;
        console.log("[DEBUG] Company details available:", this.companyName + " - " + this.logoUrl)
        this.$emit('updateCompanyDetails', {name: this.companyName, logo: this.logoUrl, email: this.technicalEmail, password: this.technicalEmailPassword});
      }
    },
