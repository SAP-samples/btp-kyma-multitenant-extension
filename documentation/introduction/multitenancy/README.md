...
![](images/authentication-flow-02.jpeg)
  ...
  1. The [Database service](/blob/main/documentation/exploration/db-service/README.md) creates a new schema/user for the new customer. Standard tables and default configuration are automatically generated.
