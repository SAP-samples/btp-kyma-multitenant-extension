...
3. Maintain your SAP HANA Cloud JDBC connection properties in the `db.*` section. This should look like this:
   ...
   See [How to find JDBC Connection Properties](/documentation/prepare/configure-hana#how-to-find-jdbc-connection-properties). 
...
To understand how this works, see section [Database Service](/documentation/explore/db-service/README.md))
...
2. The class [BPService.java](/code/backend/bp-service/src/main/java/dev/kyma/samples/easyfranchise/bpservice/BPService.java) just queries for business partners. For a more detailed explanation, see the section [Business Partner Service](/documentation/explore/bp-service/README.md).
...
### Prerequisites 
- You have a node installed as described in the section [Development Setup](/documentation/prepare/set-up-local-environment/README.md)
